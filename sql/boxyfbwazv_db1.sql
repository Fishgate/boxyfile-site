...
-- Generation Time: Jun 06, 2014 at 03:31 PM
...
INSERT INTO `orders` (`id`, `ref`, `name`, `contact_number`, `email_address`, `delivery_address`, `order_summery`, `total`, `date`, `unix`) VALUES
(1, '#5E3881', 'test', '123', 'kyle@fishgate.co.za', 'test\r\n123', '1 x Large File Set = R120.00\n', 'R120.00', '2013-05-17', '1368797611'),
(2, '#335F53', 'Quintes', '0828405509', 'quintes@fishgate.co.za', 'testing123', '1 x Small File = R10.00\n3 x Large File Set = R360.00\n2 x Document Holder Sheet = R0.00\n', 'R370.00', '2013-05-21', '1369150131'),
